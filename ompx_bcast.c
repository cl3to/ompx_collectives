...
int main(int argc, char* argv[])
{
    ...
    ompx_target_bcast(HstPtr, DevicesPtrs, Size, HstDevice, DstDevices, NumDevices);
    ...
    #pragma omp single
    {
        ...
        for(int DevIdx = 0; DevIdx < NumDevices; DevIdx++) {
            ...
            #pragma omp target firstprivate(Length, DeviceSum, DevIdx) is_device_ptr(DevicePtr)\
